...
<table cellspacing='0' cellpadding='0' width="100%">
	<tr align="center" height="100%">
		...
		<td align="center" valign="top">
			<table id='sortTb' class="dataTb">
				<tr class="title_1"><th colspan="<?php echo count($app->view->rowname); ?>"><font color="#FF2D2D"><?php echo $app->curarea;?></font> 平台——<?php echo $app->view->page['title'];?></th></tr>
				<tr class='title_3'><td colspan="<?php echo count($app->view->rowname); ?>">
					<form  action=""<?php echo $app->view->postdata?" method='post' enctype='multipart/form-data'":" method='GET'";?>>
					<?php $app->view->showFilter();?>